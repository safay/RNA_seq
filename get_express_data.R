...
#####
#
# This script takes two files and prepares them for futher differential gene expression analysis in R particularly edgeR and related analyses.
...
#  - First argument is the directory containing each of the xprs.output directories.
#  - Second argument is the path and filename to a "groups" file.
# The script will save output to the directory containing the "groups" file.
#
# Example groups file:
#
