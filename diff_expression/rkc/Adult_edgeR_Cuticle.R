...
setwd("/Users/jonathonstillman/Documents/RKC_Transcriptomics/RKC5_Adults/Analysis_by_Tissue/Cuticle/Express_Output_Cuticle")
# set output directory
out_dir <- "/Users/jonathonstillman/Documents/RKC_Transcriptomics/RKC5_Adults/Analysis_by_Tissue/Cuticle"
# get annotation file
...
# define groups
groups <- read.delim("/Users/jonathonstillman/Documents/RKC_Transcriptomics/RKC5_Adults/Analysis_by_Tissue/Cuticle/RKC5_groups_cuticle.txt", colClasses = c("character", rep("factor",3)))
str(groups)
...
DEGlist_lrt1 <- get_DEGs(lrt1, annot=transcripts, fdr=0.01, critFC=2)
...
names <- read.delim("/Users/jonathonstillman/Documents/RKC_Transcriptomics/RKC5_Adults/Analysis_by_Tissue/Cuticle/RKC5_groups_cuticle.txt", colClasses = c(rep("character",4)))
