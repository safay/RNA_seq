...
#####
#
# This script takes output from eXpress (http://bio.math.berkeley.edu/eXpress/index.html)
# and prepares it in a table for futher analysis in R, particularly edgeR and related analyses
# also needed is a table defining sample names and factors for 
#
#####
...
save(all_count, file = "../../counts.RData")
save(all_fpkm, file = "../../fpkm.RData")
